from home.image_module import commands as image_commands
# from audio import commands as audio_commands
from home.video_module import commands as video_commands
from os import path
...
def main_steg(arg):
    ...
    if '-help' in args:
        ...
        try:
            ...
            print(args_dictionary['operation_method'])
        except IndexError:
            pass
        print(args_dictionary['operation_method'])
